...
# Folder highlights
# Python code implements a multi-option banking system simulation with initial accounts for Jane Smith and others.

print("="*20)

customerNames = ['sai', 'Iason Jordan', 'David Morgan', 'Brain John', 'Jack Swift']
